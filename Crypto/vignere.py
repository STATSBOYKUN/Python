...
import itertools, re
import chiper, pyperclip, frequency, english
...
def attemptHackWithKeyLength(ciphertext, mostLikelyKeyLength):
    ...
    for nth in range(1, mostLikelyKeyLength + 1):
        ...
        # See the englishFreqMatchScore() comments in frequency.py.
        freqScores = []
        for possibleKey in LETTERS:
            decryptedText = chiper.decryptMessage(possibleKey, nthLetters)
            keyAndFreqMatchTuple = (possibleKey, frequency.englishFreqMatchScore(decryptedText))
    ...
    for indexes in itertools.product(range(NUM_MOST_FREQ_LETTERS), repeat=mostLikelyKeyLength):
        ...
        decryptedText = chiper.decryptMessage(possibleKey, ciphertextUp)

        if english.isEnglish(decryptedText):
